...
export default class HelpCommandEmbedBuilder extends DefaultEmbedBuilder {
  public constructor() {
    super();
  ...
  private readonly formatValues = (values: string[]): string => values.map(this.formatValue).sort().join(', ');
  ...
  private readonly fields: APIEmbedField[] = [
    ...
    {
      name: 'Bot invitation',
      value: '[Bot invitation](https://discord.com/oauth2/authorize?client_id=578907743122096148&permissions=842525950&scope=bot)',
      inline: true
    },
