...
export class AvatarCommandEmbedBuilder extends DefaultEmbedBuilder implements IEmbedBuilder {
  public constructor (private readonly user: User) {
    super()
  }

  public build (): EmbedBuilder {
    return this.setDescription(`[${this.user.displayName}'s avatar](${this.user.avatarURL()})`)
